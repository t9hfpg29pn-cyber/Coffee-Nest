...
// Organic "paper landscape" — large, soft, overlapping torn layers rather than a
// technical low-poly mesh. A few big shapes, visible layering, very little
// detail; the construction echoes the layered app icon.
